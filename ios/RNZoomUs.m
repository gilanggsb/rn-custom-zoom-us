...
- (void)setMeetingSettings:(NSDictionary * _Nullable)data {
    ...
    if (zoomSettings != nil) {
        ...
        if (data[@"noBottomToolbar"]) {
            zoomSettings.bottomBarHidden = data[@"noBottomToolbar"];
        }
        
        if(data[@"noDrivingMode"]){
            [zoomSettings disableDriveMode:data[@"noDrivingMode"]];
        }
        
        if(data[@"noTitlebar"]){
            [zoomSettings setMeetingTitleHidden:data[@"noTitlebar"]];
        }
        
        
        
        zoomSettings.muteVideoWhenJoinMeeting = true;
        zoomSettings.meetingParticipantHidden = true;
        [zoomSettings disableGalleryView:YES];
